...
const Projects = forwardRef<HTMLDivElement, ProjectsProps>(
  ({ projects, activeProject, setActiveProject }, ref) => {
                ...
                <div className="p-5 sm:p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.technologies.slice(0, 3).map((tech, index) => (
                      <span
                        key={index}
                        className="px-3 py-1 bg-lime-400/10 text-lime-400 text-xs rounded-md code-font"
                      >
                        {tech}
                      </span>
                    ))}
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {projects.find(p => p.id === activeProject)?.technologies.map((tech, index) => (
                              <span
                                key={index}
                                className="px-3 py-1 bg-lime-400/10 text-lime-400 rounded-md code-font"
                              >
                                {tech}
                              </span>
                            ))}
