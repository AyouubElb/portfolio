...
export default function Portfolio() {
    ...
    const handleScroll = () => {
      ...
      if (journeySectionRef.current) {
        ...
        if (journeyTop <= viewportHeight * 0.7) {
          journeyProgress = Math.min(100, ((viewportHeight * 0.7 - journeyTop) / journeyHeight) * 100)
        }
  ...
  const isElementInViewport = (el: HTMLElement, threshold = 0.8) => {
    ...
    return rect.top <= (window.innerHeight || document.documentElement.clientHeight) * threshold && rect.bottom >= 0
  }
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "radial-gradient(circle at 10% 20%, rgba(14, 60, 45, 0.8) 0%, rgb(5, 46, 22) 90%)",
      }}
    >
      {formStatus && (
        <Notification>
      ...
      <main className="pt-16">
        <Hero ref={heroRef} scrollToSection={scrollToSection} aboutRef={aboutRef} />
        ...
        <Contact ref={contactRef} handleSubmit={handleSubmit} isSubmitting={isSubmitting} />
      </main>
